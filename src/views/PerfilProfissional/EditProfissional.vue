    ...
    <form action method="POST">
      ...
      <div class="columns" style="margin-top:-40px">
        ...
        <div class="column is-4-tablet is-full-mobile is-3-desktop is-full-mobile">
          <li class="column">
            ...
            <select class="control inp" name="estado" id="estado" v-model="image.estado">
            ...
            <div class>
              <ApolloQuery :query="require('@/graphql/queries/categories.gql')">
                <template slot-scope="{ result: { data, loading },isLoading }">
                  ...
                  <div v-else>
                    <div class="columns is-mobile column is-12-desktop is-12-tablet">
                      <label for="categoria">
      ...
      <div class="control column">
        <button
          ...
          class="column is-6-desktop is-8-tablet is-offset-2-tablet is-offset-3-desktop is-full-mobile btn2"
    ...
    user_info: {
      ...
      update(data) {
        if (data) {
          ...
          var tamanho = data.imagem.ramo.length;
          console.log(tamanho);
    ...
    create() {
      if (
        ...
        if (this.image.telefone.length < 15) {
          ...
          window.axios
            .put("api/imagems/" + this.$route.params.id, this.image)
            .then(response => {
