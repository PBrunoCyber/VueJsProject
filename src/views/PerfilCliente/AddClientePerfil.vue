            ...
            <div class="column is-offset-3-desktop is-4-tablet is-offset-2-tablet is-3-desktop is-full-mobile">
              <li class="column">
                <div class="columns is-mobile" style="margin-left:0px">
                  ...
                  <label v-if="!this.perfilCli.cidade" for="cidade" style="margin-left:10px;color:red"><b>*</b></label>
                </div>
                <input
                  type="text"
                  class="input inp"
            ...
            <div class="column is-3-desktop is-4-tablet is-full-mobile">
              <li class="column">
                <div class="columns is-mobile" style="margin-left:0px"> 
                  ...
                  <label v-if="!this.perfilCli.estado" for="estado" style="margin-left:10px;color:red"><b>*</b></label>
                </div>
                <select
            ...
            <div class="control column is-6-desktop is-offset-3-desktop is-8-tablet is-offset-2-tablet is-full-mobile">
              <li class="column">
                <div class="columns is-mobile" style="margin-left:0px"> 
                  ...
                  <label v-if="!this.perfilCli.logradouro" for="logradouro" style="margin-left:10px;color:red"><b>*</b></label>
                </div>
                <input
                  type="text"
                  class="input inp"
            ...
            <div class="control column is-3-desktop is-4-tablet is-full-mobile">
              <li class="column">
                <div class="columns is-mobile" style="margin-left:0px"> 
                  ...
                  <label v-if="!this.perfilCli.telefone" for="telefone" style="margin-left:10px;color:red"><b>*</b></label>
                </div>
                <input
                  type="text"
    ...
    create() {
      if(!this.perfilCli.cidade || !this.perfilCli.estado || !this.perfilCli.logradouro || !this.perfilCli.telefone){
        ...
        if(this.perfilCli.telefone.length < 15){
          ...
          window.axios.post("api/perfil_clientes", this.perfilCli).then(() => {
