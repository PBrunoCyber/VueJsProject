<template>
  <div class="pedidos">
    ...
    <!-- FIM DO BREADCRUMB -->
    <h3
      class="column is-6-desktop is-10-tablet is-offset-3-desktop is-offset-1-tablet is-full-mobile"
      style="text-align:center;color:black;font-size:25pt;text-transform:uppercase"
      align="center"
    >
      <b>Abaixo estão seus pedidos para profissionais específicos.</b>
    </h3>
    <br />
    <br />
    <div v-if="this.cli.clientForUserId">
              ...
              <div v-if="data">
                          ...
                          <div class="column">
                            ...
                            <div class="level-item" style="margin-top:-15px">
                              <router-link
                                :to="`/page/cliente/categories/profissional/${pedido.user_recebe.id}`"
                              >
                                <div class="level-item" style="color:black">
                                  <b>{{pedido.user_recebe.user.name}}</b>
                                </div>
                              </router-link>
                            </div>
                          </div>
                        ...
                        <div class="column is-9-desktop is-full-mobile">
                          <div class="columns column">
                            <div class="column is-9-desktop is-9-tablet">
                              <div style="color:black;text-transform:uppercase;font-size:16pt">
                                <b>{{pedido.titulo}}</b>
                              </div>
                            </div>
                            <div
                              class="column is-1-desktop is-offset-2-desktop is-3-tablet"
                              style="margin-top:-10px"
                              v-if="pedido.status === 0"
                            >
                              <button
                                style="border-radius:0px;text-align:center"
                                class="btnhover column is-12-desktop is-12-tablet is-full-mobile"
                                @click.prevent="editar(pedido.id)"
                              >
                                <i
                                  class="material-icons"
                                  style="margin-right:5px;font-size:12pt;color:blue"
                                >edit</i>
                                <span></span>
                              </button>
                            </div>
                          ...
                          <br />
                          <div
                            class="columns is-mobile column"
                          ...
                          <div
                            class="columns is-mobile column"
                            style="margin-top:-45px;color:black"
                          >
                            <div class="column is-6-desktop">
                              <b>Valor:</b>
                              {{pedido.valor}}
                      ...
                      <div style="margin-top:-20px">
                        <div v-if="pedido.status===0">
                          ...
                          >
                            ...
                            >
                              <div
                                class="message-body"
                              >OBS: Espere um pouco até {{pedido.user_recebe.user.name}} poder analisar sua proposta</div>
                            </article>
                          </b>
                        </div>
                          ...
                          <b style="color:black;padding:0">
                            <article class="message is-success" style="text-align:center">
                              <div class="message-body">
                                O (a) {{pedido.user_recebe.user.name}} aceitou sua proposta entre em contato com ele através do número: {{pedido.user_recebe.telefone}} ou pelo email {{pedido.user_recebe.user.email}}, veja a disponibilidade dele(a)
                                <router-link
                                  style="color:blue"
                                  :to="`/page/cliente/pedidos/orcamento/${pedido.orcamento[0].id}`"
                                >aqui</router-link>.
                              </div>
                            </article>
                          </b>
                          ...
                          >
                            ...
                            >
                              <div
                                class="message-body"
                                style="color:black;"
                              >O(A) {{pedido.user_recebe.user.name}} infelizmente recusou seu pedido :(</div>
                            </article>
                          </b>
                        </div>
                        <div v-if="pedido.status === 3">
                          ...
                          >
                            ...
                            >
                              <b>
                                O {{pedido.user_recebe.user.name}} finalizou esse serviço, agora você pode avaliá-lo, avalie o desempenho dele(a) nesse serviço
                                <router-link
                                  :to="`/page/cliente/pedidos/avaliacao/${pedido.id}`"
                                  style="color:blue"
                                >aqui</router-link>
                              </b>
                            </div>
                        ...
                        <div v-if="pedido.status === 4">
                          ...
                          >
                            <article style="text-align:center;color:black">
                              ...
                              >Usuário foi avaliado para esse serviço veja o perfil dele(a).</div>
                            </article>
                          </b>
                        </div>
                      </div>
                ...
                <div v-if="data && data.propostaEnvia.data">
                  <div
                    ...
                    v-if="data.propostaEnvia.data[0]"
                  >
                    <!-- VOLTAR -->
                    ...
                    <b
                      ...
                      v-if="data.propostaEnvia.paginatorInfo.lastPage > 11"
                    >...</b>
                    <div v-if="data.propostaEnvia.paginatorInfo.lastPage > 10">
                      <div v-if="page === data.propostaEnvia.paginatorInfo.lastPage">
                        <a
                          class="button"
                          style="margin:5px;background:rgb(71, 71, 71);color:white"
                        >{{data.propostaEnvia.paginatorInfo.lastPage}}</a>
                      </div>
                      <div v-else>
                        <a
                          class="button button-solicita"
                          style="margin:5px"
                          @click.prevent="ultimaPagina(data.propostaEnvia.paginatorInfo.lastPage)"
                        >{{data.propostaEnvia.paginatorInfo.lastPage}}</a>
                      </div>
                    </div>
                    <!-- PRÓXIMO -->
      ...
      <div v-if="!this.cli.clientForUserId[0]">
        <div
          class="column is-8-desktop is-offset-2-desktop column is-8-tablet is-offset-2-tablet is-10-mobile is-offset-1-mobile card"
          style="text-align:center;text-transform:uppercase;font-weight:bold;color:black"
        >Você ainda não se cadastrou completamente.</div>
      </div>
    </div>
